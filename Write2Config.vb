Public Class Write2Config
    Public Sub prepare(_Resource As Resources)
        Dim TempString(,) As String = {
                                        {_Resource.config(15, 0), _Resource.config(15, 1)},
                                        ...
                                        {_Resource.color(7, 0), _Resource.color(7, 1) & "," & _Resource.color(7, 2) & "," & _Resource.color(7, 3)},
                                        {_Resource.color(8, 0), _Resource.color(8, 1) & "," & _Resource.color(8, 2) & "," & _Resource.color(8, 3)},
                                        {_Resource.color(9, 0), _Resource.color(9, 1) & "," & _Resource.color(9, 2) & "," & _Resource.color(9, 3)},
                                        {_Resource.delay(0, 0), _Resource.delay(0, 1)},
                                        {_Resource.delay(1, 0), _Resource.delay(1, 1)},
                                        {_Resource.delay(2, 0), _Resource.delay(2, 1)},
                                        {_Resource.config(16, 0), _Resource.config(16, 1)},
                                        ...
                                        {_Resource.config(17, 0), _Resource.config(17, 1)},
                                        ...
                                        {_Resource.macro(0, 0), _Resource.macro(0, 1)},
                                        {_Resource.macro(2, 0), _Resource.macro(2, 1)},
                                        {_Resource.macro(3, 0), _Resource.macro(3, 1)},
                                        {_Resource.macro(4, 0), _Resource.macro(4, 1)},
                                        {_Resource.macro(5, 0), _Resource.macro(5, 1)},
                                        {_Resource.macro(6, 0), _Resource.macro(6, 1)},
                                        {_Resource.macro(7, 0), _Resource.macro(7, 1)},
                                        {_Resource.macro(8, 0), _Resource.macro(8, 1)},
                                        {_Resource.macro(9, 0), _Resource.macro(9, 1)},
                                        {_Resource.macro(10, 0), _Resource.macro(10, 1)},
                                        {_Resource.macro(11, 0), _Resource.macro(11, 1)},
                                        {_Resource.macro(12, 0), _Resource.macro(12, 1)},
                                        {_Resource.macro(13, 0), _Resource.macro(13, 1)},
                                        {_Resource.macro(14, 0), _Resource.macro(14, 1)},
                                        {_Resource.macro(15, 0), _Resource.macro(15, 1)},
                                        {_Resource.macro(16, 0), _Resource.macro(16, 1)},
                                        {_Resource.macro(17, 0), _Resource.macro(17, 1)},
                                        {_Resource.macro(18, 0), _Resource.macro(18, 1)},
                                        {_Resource.macro(19, 0), _Resource.macro(19, 1)},
                                        {_Resource.minimap(0, 0), _Resource.minimap(0, 1)},
                                        {_Resource.minimap(6, 0), _Resource.minimap(6, 1)},
                                        ...
                                        {_Resource.config(12, 0), _Resource.config(12, 1)},
                                        ...
                                        {_Resource.config(18, 0), _Resource.config(18, 1)},
                                        ...
                                        {_Resource.wardmap(0, 0), _Resource.wardmap(0, 1)},
                                        {_Resource.wardmap(1, 0), _Resource.wardmap(1, 1)},
