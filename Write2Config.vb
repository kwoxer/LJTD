Public Class Write2Config
    Public Sub ConfigFile_Prepare(_Resource As Resources)
        Dim tempString(,) As String = {
                                        ...
                                        {_Resource.PropMinimap(23, 0), _Resource.PropMinimap(23, 1)},
                                        ...
                                        {_Resource.PropTextOverlay(2, 0), _Resource.PropTextOverlay(2, 1)},
                                        {_Resource.PropTextOverlay(3, 0), _Resource.PropTextOverlay(3, 1)},
                                        {_Resource.PropTextOverlay(0, 0), _Resource.PropTextOverlay(0, 1)},
                                        {_Resource.PropTextOverlay(1, 0), _Resource.PropTextOverlay(1, 1)},
                                        {_Resource.PropTextOverlay(4, 0), _Resource.PropTextOverlay(4, 1)},
