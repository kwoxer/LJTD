Public Class Write2Config
    Public Sub ConfigFile_Prepare(_Resource As Resources)
        Dim tempString(,) As String = {
                                        ...
                                        {_Resource.PropConfig(22, 0), _Resource.PropConfig(22, 1)},
                                        {_Resource.PropConfig(23, 0), _Resource.PropConfig(23, 1)},
                                        ...
                                        {_Resource.PropConfig(28, 0), _Resource.PropConfig(28, 1)},
                                        ...
                                        {_Resource.PropName(7, 0), _Resource.PropName(7, 1)},
                                        ...
                                        {_Resource.PropConfig(26, 0), _Resource.PropConfig(26, 1)},
                                        ...
                                        {_Resource.PropRemember(6, 0), _Resource.PropRemember(6, 1)},
                                        {_Resource.PropRemember(3, 0), _Resource.PropRemember(3, 1)},
                                        {_Resource.PropRemember(4, 0), _Resource.PropRemember(4, 1)},
                                        {_Resource.PropRemember(5, 0), _Resource.PropRemember(5, 1)},
                                        {_Resource.PropConfig(24, 0), _Resource.PropConfig(24, 1)},
                                        ...
                                        {_Resource.PropConfig(25, 0), _Resource.PropConfig(25, 1)},
                                        ...
                                        {_Resource.PropConfig(27, 0), _Resource.PropConfig(27, 1)},
    ...
    Public Sub ConfigFile_Write(tempString(,) As String, resource As Resources)
        ...
        Catch ex As Exception
            objWriter.Close()
            Module_Logfile.Logfile_Append("The setting could not be saved properly. Please re-download LJTD from the website.")
        End Try
    End Sub
End Class
