...
Public Class VisceralGroupBox : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(e As System.Windows.Forms.PaintEventArgs)
        Dim B As New Bitmap(Width, Height)
        Dim G As Graphics = Graphics.FromImage(B)
        Dim TopBar As New Rectangle(10, 5, 200, 15)
        ...
        'Dim bodygrade As New LinearGradientBrush(ClientRectangle, Color.FromArgb(150, 150, 150), Color.FromArgb(22, 22, 22), 120S)
