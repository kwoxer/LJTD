...
Public Class Form1
    ...
    Private Sub Button_baron_Click(sender As System.Object, e As System.EventArgs) Handles Button_baron.Click
        ...
        If _Difference <> 0 Then
            _Button(number).Enabled = False
            _Buffs(number).starts()
            If CBool(_Resources.write_2_chat) Then
                Chat.write(_Buffs(number).generateText(_Timing.buffEnding(_Buffs(number).Duration, _Difference, _StartingDateTime)))
            End If
        End If
    End Sub
